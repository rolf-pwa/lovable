...
const DiscoveryEmbed = lazy(() => import("./pages/DiscoveryEmbed"));
const DiscoveryV2 = lazy(() => import("./pages/DiscoveryV2"));
const DiscoveryV2Embed = lazy(() => import("./pages/DiscoveryV2Embed"));
const VfoOnboardingEmbed = lazy(() => import("./pages/VfoOnboardingEmbed"));
const ProPortalLogin = lazy(() => import("./pages/ProPortalLogin"));
const ProPortal = lazy(() => import("./pages/ProPortal"));
const ProPortalFamily = lazy(() => import("./pages/ProPortalFamily"));
const ProPortalHousehold = lazy(() => import("./pages/ProPortalHousehold"));
const ProPortalContact = lazy(() => import("./pages/ProPortalContact"));
...
const BulkOnboarding = lazy(() => import("./pages/BulkOnboarding"));
const BulkImporters = lazy(() => import("./pages/BulkImporters"));
const IntakeTest = lazy(() => import("./pages/IntakeTest"));
const Analytics = lazy(() => import("./pages/Analytics"));
const StabilizationMap = lazy(() => import("./pages/StabilizationMap"));
const StabilizationMapResolver = lazy(() => import("./pages/StabilizationMapResolver"));
const QuarterlySystemReview = lazy(() => import("./pages/QuarterlySystemReview"));
const QuarterlySystemReviewResolver = lazy(() => import("./pages/QuarterlySystemReviewResolver"));
const QuarterlyReview = lazy(() => import("./pages/QuarterlyReview"));
const GovernanceReview = lazy(() => import("./pages/GovernanceReview"));
const SovereigntyCharter = lazy(() => import("./pages/SovereigntyCharter"));

...
// Requests always belong to whichever member submitted them — this just
// rolls every household member's requests into one place so staff working
// at the household level don't have to click into each person to see them.
export function HouseholdRequestsRollup({ members }: Props) {
          ...
          return (
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[10px] text-muted-foreground/80 mt-0.5">{nameFor(req.contact_id)}</p>
              </div>

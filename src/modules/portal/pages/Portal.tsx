      ...
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="mx-4 w-full max-w-md space-y-8 text-center">
          ...
          <div className="rounded-lg border border-border bg-card p-8 text-left space-y-5">
            {/* Google Sign-In temporarily disabled: the GCP OAuth consent
                screen is set to "Internal" (Workspace-only) to cover staff's
                Gmail/Calendar/Drive scopes without Google's verification
                review — but that setting is project-wide, so it also blocks
                every client's personal Google account with "Access blocked:
                can only be used within its organization." Re-enable once
                client login moves to its own External-type OAuth client. */}
            {!otpSent ? (
              <>
